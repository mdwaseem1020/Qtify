    ...
    <div className='container-fluid' style={{padding:"100px 70px 50px 100px",backgroundColor:"black",boxShadow:"0px 0px 1px 1px #34c94b"}}>
      ...
      <Carousel className='caro3'>
                           ...
                           <Card  style={{ width: '8rem' ,backgroundColor:'#34c94b'}} onClick={()=>navigate(`/info3/${x.title}`,{state:{x}})}>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                <p style={{color:'white',fontSize:'13px',fontSize:"15px",position:"relative",top:"-10px"}}>{x.likes}</p>                                 </Card.Text>
                            </Card.Body>
                            </Card>
                            <p style={{color:'white',fontSize:'13px',width:"8rem",fontSize:"15px",position:"relative",top:"-45px"}}>{x.title}</p> 
                            </div> 
                                </>)
                            })}
                            </div>
     ...
     {data.filter(x=>x.genre.key.toLowerCase().includes(search)).slice(10,20).map(x=>{
                            ...
                            <Card.Body>
                                <Card.Title></Card.Title>
                                <Card.Text>
                                <p style={{color:'white',fontSize:'13px',fontSize:"15px",position:"relative",top:"-10px"}}>{x.likes}</p>
                                </Card.Text>
                            </Card.Body>
                            </Card>
                            <p style={{color:'white',fontSize:'13px',width:"8rem",fontSize:"15px",position:"relative",top:"-45px"}}>{x.title}</p>  
